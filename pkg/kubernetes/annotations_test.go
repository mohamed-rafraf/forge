	...
	tests := []struct {
	...
	}{
		{
			...
			obj: &corev1.Node{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"forge-build.io/some-other-annotation": "",
					},
				},
				Spec:   corev1.NodeSpec{},
				Status: corev1.NodeStatus{},
			},
			annotationKey: "forge-build.io/machineType",
			expected:      false,
		},
		{
			name: "no val",
		...
		},
		{
			...
			obj: &corev1.Node{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"forge-build.io/machineType": "true",
					},
				},
				Spec:   corev1.NodeSpec{},
				Status: corev1.NodeStatus{},
		...
		},
		{
			...
			obj: &corev1.Node{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"forge-build.io/machineType": "foo",
					},
				},
				Spec:   corev1.NodeSpec{},
				Status: corev1.NodeStatus{},
		...
		},
		{
			...
			obj: &corev1.Node{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"forge-build.io/machineType": "false",
					},
				},
				Spec:   corev1.NodeSpec{},
				Status: corev1.NodeStatus{},
